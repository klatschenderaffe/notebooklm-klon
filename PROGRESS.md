...
**Noch offen:** Committen + PR + Merge; danach Migration `0006` auf Staging und Produktion einspielen — erst nachdem der neue Code dort deployt ist (siehe Hinweis oben).
